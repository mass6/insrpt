...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/js/editor/examples/resources/syntax/shCore.css">
	<link rel="stylesheet" type="text/css" href="/js/editor/examples/resources/demo.css">
	...
	<script type="text/javascript" language="javascript" src="/js/editor/js/dataTables.editor.min.js"></script>
	<script type="text/javascript" language="javascript" src="/js/editor/examples/resources/syntax/shCore.js"></script>
	<script type="text/javascript" language="javascript" src="/js/editor/examples/resources/demo.js"></script>
	<script type="text/javascript" language="javascript" src="/js/editor/examples/resources/editor-demo.js"></script>
		...
		buttons: [
			...
			{ extend: &quot;remove&quot;, editor: editor }
					...
					<ul>
						...
						<li><a href="https://cdn.datatables.net/1.10.9/js/jquery.dataTables.min.js">https://cdn.datatables.net/1.10.9/js/jquery.dataTables.min.js</a></li>
						<li><a href=
						"https://cdn.datatables.net/buttons/1.0.3/js/dataTables.buttons.min.js">https://cdn.datatables.net/buttons/1.0.3/js/dataTables.buttons.min.js</a></li>
						<li><a href=
						"https://cdn.datatables.net/select/1.0.1/js/dataTables.select.min.js">https://cdn.datatables.net/select/1.0.1/js/dataTables.select.min.js</a></li>
						<li><a href="../../js/dataTables.editor.min.js">../../js/dataTables.editor.min.js</a></li>
					</ul>
				</div>
				...
				<div class="css">
					...
					<ul>
						<li><a href="https://cdn.datatables.net/1.10.9/css/jquery.dataTables.min.css">https://cdn.datatables.net/1.10.9/css/jquery.dataTables.min.css</a></li>
						<li><a href=
						"https://cdn.datatables.net/buttons/1.0.3/css/buttons.dataTables.min.css">https://cdn.datatables.net/buttons/1.0.3/css/buttons.dataTables.min.css</a></li>
						<li><a href=
						"https://cdn.datatables.net/select/1.0.1/css/select.dataTables.min.css">https://cdn.datatables.net/select/1.0.1/css/select.dataTables.min.css</a></li>
						<li><a href="../../css/editor.dataTables.min.css">../../css/editor.dataTables.min.css</a></li>
					</ul>
				</div>
				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc">
							...
							<li><a href="../simple/multiRow.html">Multi-row editing</a></li>
					...
					<div class="toc-group">
						...
						<ul class="toc active">
							...
							<li><a href="./multiItem.html">Multi-item editing (rows, columns, cells)</a></li>
							...
							<li><a href="./upload-many.html">File upload (many)</a></li>
						</ul>
					</div>
					...
					<div class="toc-group">
						...
						<ul class="toc">
							<li><a href="../extensions/keyTable.html">Excel like keyboard navigation</a></li>
							<li><a href="../extensions/autoFill.html">Excel like AutoFill feature</a></li>
							<li><a href="../extensions/excel.html">AutoFill and KeyTable together</a></li>
							<li><a href="../extensions/exportButtons.html">Export buttons</a></li>
							<li><a href="../extensions/responsive.html">Responsive table extension</a></li>
							<li><a href="../extensions/rowReorder.html">Row reordering</a></li>
						</ul>
					</div>
					...
					<div class="toc-group">
						...
						<ul class="toc">
							...
							<li><a href="../inline-editing/submitData.html">Editing options - submit full row data</a></li>
					...
					<div class="toc-group">
						...
						<ul class="toc">
							...
							<li><a href="../api/cancelButton.html">Cancel button</a></li>
					...
					<div class="toc-group">
						...
						<ul class="toc">
							...
							<li><a href="../styling/fieldDisplay.html">Field display styling options</a></li>
							<li><a href="../styling/columns.html">Multi-column layout</a></li>
							<li><a href="../styling/large.html">Large window layout</a></li>
							<li><a href="../styling/stackedInputs.html">Stacked inputs</a></li>
