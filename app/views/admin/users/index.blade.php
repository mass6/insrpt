...
@section('page-head')
    @include('layouts.horizontal.partials._page-head', ['heading' => 'Users'])
@stop
...
@section('content')
    ...
    <div class="portlet light">
        <div class="portlet-title">
            ...
            <div class="actions">
                 @if($currentUser->hasAccess('admin.users.create'))
                     <a href="{{ route('admin.users.create') }}" class="btn btn-circle blue ">
                ...
                <table id="datatable" class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{ link_to_route('admin.users.edit', 'Edit', array($user->id), array('class' => 'btn btn-link small-link')) }}
                            {{ Form::submit('Delete', array('class' => 'btn btn-link small-link', 'Onclick'=>'return confirm("Are you sure you want to delete this user?")')) }}
                            {{ Form::close() }}
                        </td>
                    </tr>
                    @endforeach
