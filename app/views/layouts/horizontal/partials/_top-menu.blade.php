...
<div class="top-menu">
    <ul class="nav navbar-nav pull-right">
        ...
        {{--<li class="dropdown dropdown-extended dropdown-light dropdown-notification" id="header_notification_bar">--}}
        ...
        <!-- BEGIN TODO DROPDOWN -->
        {{--<li class="dropdown dropdown-extended dropdown-light dropdown-tasks" id="header_task_bar">--}}
            {{--<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">--}}
        ...
        @if($currentUser->hasAccess('company-settings'))
            <li>
                <a href="{{ route('company-settings.edit') }}">
                    Company Settings <i class="icon-settings"></i>
                </a>
            </li>
        @endif
        ...
        <li class="dropdown dropdown-user dropdown-light">
            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
            <img alt="" class="img-circle" src="{{ $currentUser->profile->avatar->url('thumb') }}">
