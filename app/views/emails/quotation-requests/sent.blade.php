                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <hr/>
                            <span>To: <strong>{{$supplier}}</strong></span><br/>
                            <span>From: <strong>{{$company}}</strong></span>

                            <h3>Hello {{ $sentTo }},</h3>

                            <p>Please find the attached request containing {{ $num_products }} products for your quotation.</p>

                            <h3>Comments:</h3>
                            <p style="font-family: Courier, monospace;">{{ $message_body }}</p>
                            <hr/>
                            <br/>
