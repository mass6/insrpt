...
<head>
    ...
    <title>Orders Pending Approval Report</title>
    <style>
        /* -------------------------------------
                GLOBAL
        ------------------------------------- */
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <hr/>
                            <h3>Hello,</h3>
                            <p>The attached report contains orders that currently pending approval for {{ $customer_name }} on the Insight portal. ({{$url}})</p>
