                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <hr/>
                            <h3>Hello,</h3>
                            <p>The following line items are from orders that have recently been added on the portal.({{$url}})</p>

                            <table border="1">
                                @foreach($data as $order_line)
                                    <tr>

                                        @foreach(explode(",",$order_line) as $field)
                                            <td valign="top"> <font face="Arial" size="1"> {{ $field }} </font> </td>
                                        @endforeach
