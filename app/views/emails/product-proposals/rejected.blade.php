...
<head>
    ...
    <title>Product Proposal Rejected</title>
    <style>
        /* -------------------------------------
                GLOBAL
        ------------------------------------- */
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <hr/>
                            <h3>Hello {{ $submittedBy }},</h3>
                            <p>This is to inform you that the following Product Proposal has been rejected by <strong>{{ $rejectedBy }}</strong>.</p>
                            ...
                            @if(! empty($proposal['remarks']))
                                <div>
                                    <h3>Rejection Reason:</h3>
                                    <p><em>"{{$proposal['remarks']}}"</em></p>
                                </div>
                                <br/>
                            @endif
