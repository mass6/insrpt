...
/**
 * Class AddNewSupplierCommandHandler
 * @package Insight\Companies
 */
class AddNewSupplierCommandHandler extends CompanyCommandHandlerAbstract
{
    ...
    public function handle($command)
    {
        ...
        $customer_company = $this->companyRepository->findById($command->customer_company_id);
        $this->companyRepository->addSupplier($customer_company, $supplier_id);
