...
namespace Insight\Libraries\StateMachine;
...
//    }
     ...
     * @return mixed
     */
    public static function getInitialTransitions()
    {
        $model = new static();

        return $model->getAvailableTransitions();
    }
    ...
    {
        if (method_exists($this, 'filterTransitions')) {
        ...
        foreach ($transitions as $transition) {
            $availableTransitions[$transition] = static::transitionLabel($transition);
        }
