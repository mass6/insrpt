...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected, bCaseSensitive) {
            ...
            var r = '<select class="search_init select_filter" rel="'+ i +'"><option value="" class="search_init" >' + sLabel + '</option>'; // edited per issue #150
            var j = 0;
            ...
            select.change(function () {
                ...
                if (bRegex)
                    oTable.fnFilter($(this).val(), $(this).attr('rel'), bRegex, true, true, bCaseSensitive); //Issue 41
                else
                    oTable.fnFilter(unescape($(this).val()), $(this).attr('rel'), bRegex, true, true, bCaseSensitive); //Issue 25
                fnOnFiltered();
            });
            if (currentFilter != null && currentFilter != "")//Issue 81
