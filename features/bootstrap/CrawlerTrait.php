...
trait CrawlerTrait
{
    ...
    protected function makeRequest($method, $uri, $parameters = [], $cookies = [], $files = [])
    {
        ...
        // Set the response property with the results of call()
        $this->response = $this->call($method, $uri, $parameters, $files);
     ...
     */
    public function callOLD($method, $uri, $parameters = [], $cookies = [], $files = [], $server = [], $content = null)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function callSecureOLD($method, $uri, $parameters = [], $cookies = [], $files = [], $server = [], $content = null)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function actionOLD($method, $action, $wildcards = [], $parameters = [], $cookies = [], $files = [], $server = [], $content = null)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function routeOLD($method, $name, $routeParameters = [], $parameters = [], $cookies = [], $files = [], $server = [], $content = null)
    {
